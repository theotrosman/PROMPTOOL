...
const translations = {
  es: {
    ...
    // App principal
    analyzeWithAI: 'Evaluar prompt',
    analyzing: 'Analizando...',
    noImageAvailable: 'Sin imagen disponible',
    configure: 'Configurar',
    reset: 'Reiniciar',
    newRandom: 'Nueva imagen',
    ...
    promptPlaceholder: '¿Qué ves en la imagen? Describí los personajes, el lugar, los colores y la sensación general…',
    promptRecommendation: 'Cuanto más detallado, mejor. Mencioná la luz, el estilo y el ambiente.',
  ...
  en: {
    ...
    promptPlaceholder: 'What do you see? Describe the characters, setting, colors and overall mood…',
    promptRecommendation: 'The more detail, the better. Mention light, style and atmosphere.',
