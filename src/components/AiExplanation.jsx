const AiExplanation = ({ explanation }) => (
  <div className="rounded-[1.75rem] border border-slate-200/70 bg-white p-6 shadow-sm sm:p-7">
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1">
        <h3 className="text-xl font-semibold text-slate-900">Análisis de la IA</h3>
