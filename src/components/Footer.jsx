    ...
    <div className="mx-auto w-full max-w-7xl px-6 py-5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-4 text-sm text-slate-400">
          <span className="hidden sm:inline text-slate-300">Built by</span>
          <a
            href="https://github.com/Felibeck"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/felipe-beckford/"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 transition hover:text-slate-700"
          >
          ...
          <a
            href="https://github.com/theotrosman"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 transition hover:text-slate-700"
          >
